var fillNews = function(e) {
        ...
        e.forEach(function(e, t) {
            $t(e.node, "click", function() {
                ! function n(e) {
                    ...
                    e = e.replace(/^[NV](\d+)$/i, "$1"), Qn(Or(t.protocol + "/api", {
                        p0: t.gameID,
                        p1: "updateTotalPlay",
                        p2: e,
                        p3: r,
    ...
    return e.detail = function hi(e) {
        (function g(o) {
            ...
            }, "utf-8"), Qn("".concat(o.protocol, "/api?p0=").concat(r, "&p1=updateTotalPlay&p2=").concat(a, "&p3=").concat(l ? 1 : t ? 2 : 3, "&p5=1&source=").concat(n), function() {})
