var fillNews = function(e) {
    ...
    var h = t(function(e) {
        ...
        T = x("native-function-to-string", Function.toString),
        S = t(function(e) {
            var o = m("src"),
                t = "toString",
                a = ("" + T).split(t);
    ...
    var L, k = I,
        ...
        W = (L = !1, function(e, t, n) {
            ...
            if (L && t != t) {
                ...
                for (; a < o; a++)
                    if ((L || a in i) && i[a] === t) return L || a || 0; return !L && -1
        }),
        G = z("IE_PROTO"),
        B = function(e, t) {
            var n, r = P(e),
        ...
        ee = !Z || s(function() {
            ...
            for (var n = Q(e), r = arguments.length, i = 1, o = K.f, a = Y.f; i < r;)
                for (var c, u = M(arguments[i++]), l = o ? X(u).concat(o(u)) : X(u), s = l.length, p = 0; p < s;) c = l[p++], f && !a.call(u, c) || (n[c] = u[c]);
            return n
        } : Z;
    k(k.S + k.F, "Object", {
        assign: ee
        ...
        ot = function(n, e, t) {
            ...
            if (!o || !i || "replace" === n && !rt || "split" === n && !it) {
                var a = /./ [r],
                    ...
                    u = c[0],
                    l = c[1];
                S(String.prototype, n, u), b(RegExp.prototype, r, 2 == e ? function(e, t) {
    ...
    function Et(e) {
        return null == e ? e === undefined ? St : Tt : _t && _t in Object(e) ? function a(e) {
            var t = mt.call(e, bt),
                n = e[bt];
            try {
                e[bt] = undefined;
    ...
    function Ot(e) {
        return "symbol" == typeof e || function t(e) {
        ...
        var o = !1,
            a = Vt(function() {
                o ? (a.cancel(), function i(e) {
                    ...
                    for (; e.parentNode && e.parentNode !== document;)
                        if ("string" == typeof Yt(e = e.parentNode, "opacity") && "0" === Yt(e, "opacity")) return !0;
                    return !1
                }(r) || (o = !0, e())
            }, 200);
    ...
    var un = z("IE_PROTO"),
        ln = Object.prototype,
        sn = Object.getPrototypeOf || function(e) {
        ...
        hn = function(e, t, n, r, i, o, a) {
            ...
            if (m && (l = sn(m.call(new e))) !== Object.prototype && l.next && (an(l, p, !0), "function" != typeof l[pn] && b(l, pn, gn)), f && h && h.name !== dn && (d = !0, y = function() {
                return h.call(this)
            }), !fn && !d && g[pn] || b(g, pn, y), nn[t] = y, nn[p] = gn, i)
                if (c = {
                    values: f ? y : s(dn),
                    keys: o ? y : s("keys"),
                    entries: v
                }, a)
                    for (u in c) u in g || S(g, u, c[u]);
    ...
    for (var vn = qe("iterator"), mn = qe("toStringTag"), wn = nn.Array, bn = {
        ...
        var Sn, _n = xn[Tn],
            ...
            jn = h[_n],
            On = jn && jn.prototype;
        if (On && (On[vn] || b(On, vn, wn), On[mn] || b(On, mn, _n), nn[_n] = wn, En))
            for (Sn in yn) On[Sn] || S(On, Sn, yn[Sn], !0)
    }
    var In = {};
    ...
    var kn = Array.isArray || function Fr(e) {
            return "Array" == R(e)
        },
        Nn = qe("species"),
        Rn = function(e, t) {
        ...
        Mn = function(p, e) {
            var f = 1 == p,
                ...
                m = e || Rn;
            return function(e, t, n) {
                for (var r, i, o = Q(e), a = M(o), c = j(t, n, 3), u = V(a.length), l = 0, s = f ? m(e, u) : d ? m(e, 0) : undefined; l < u; l++)
                    if ((v || l in a) && (i = c(r = a[l], l, o), p))
                        if (f) s[l] = i;
                        else if (i) switch (p) {
                    case 3:
                        return !0;
    ...
    k(k.P + k.F * (Hn || !Cn(Vn)), "Array", {
        lastIndexOf: function(e) {
            ...
            var t = P(this),
                n = V(t.length),
                r = n - 1;
            for (1 < arguments.length && (r = Math.min(r, F(arguments[1]))), r < 0 && (r = n + r); 0 <= r; r--)
    ...
    function Zn(e, t, n, r) {
        if (t = t || function() {}, window.XDomainRequest) {
    ...
    function hr(e, t) {
        ...
        if (Array.isArray(t.sCoverList))
            for (var a = 0; a < t.sCoverList.length; a++) {
    ...
    ot("split", 2, function(i, o, y, v) {
        var m;
        return m = "c" == "abbc" [xr](/(b)*/)[1] || 4 != "test" [xr](/(?:)/, -1)[Tr] || 2 != "ab" [xr](/(?:ab)*/)[Tr] || 4 != "." [xr](/(.?)(.?)/)[Tr] || 1 < "." [xr](/()()/)[Tr] || "" [xr](/.?/)[Tr] ? function(e, t) {
            var n = String(this);
        ...
        } : "0" [xr](undefined, 0)[Tr] ? function(e, t) {
                ...
                for (var s = 0, p = 0, f = []; p < i.length;) {
                    ...
                    if (null === g || (d = wr(V(u.lastIndex + (Er ? 0 : p)), i.length)) === s) p = He(i, p, a);
                        ...
                        for (var h = 1; h <= g.length - 1; h++)
                            if (f.push(g[h]), f.length === l) return f;
                        p = s = d
                    }
                }
    ...
    }, Vr._immediateFn = "function" == typeof setImmediate && function(e) {
        setImmediate(e)
    } || function(e) {
        Dr(e, 0)
        ...
        e.forEach(function(e, t) {
            $t(e.node, "click", function() {
                ! function n(e) {
                    ...
                    e = e.replace(/^[NV](\d+)$/i, "$1"), Qn(Or(t.protocol + "/index.php/api", {
                        p0: t.gameID,
                        p1: "updateTotalPlay",
                        p2: e,
                        p3: r,
    ...
    function ai(l, s, p, f) {
        ...
        if ("string" == typeof l.rank) l.rank.match(/-d$/) || ("news" !== l._newsType && (l.newsType = "video"), e = "".concat(l.protocol, "//gicp.qq.com/wmp/data/js/v3/WMP_").concat("video" === l.newsType ? "" : "NEWS_", "RANKLIST_GW_").concat(l.gameID, ".js"), t = "video" === l.newsType ? "rankObj" : "newsRankObj");
            ...
            else e = Or(l.protocol + "/index.php/api", {
                p0: l.gameID,
            ...
            if ("success" === t) {
                ...
                }), r, l), l.pager && ("laypage" === l.pager.type ? p || oi(l) : l.pager.type.match(/^click|scroll$/) && function u(n) {
    ...
    var pi = Object.is || function r(e, t) {
    ...
    return e.detail = function hi(e) {
        (function g(o) {
            ...
            }, "utf-8"), Qn("".concat(o.protocol, "/index.php/api?p0=").concat(r, "&p1=updateTotalPlay&p2=").concat(a, "&p3=").concat(l ? 1 : t ? 2 : 3, "&p5=1&source=").concat(n), function() {})
